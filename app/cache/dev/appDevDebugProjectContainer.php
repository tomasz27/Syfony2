...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Translatable\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Loggable\\Entity'), 2 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Tree\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Acme\\ProfileBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Acme\\AlertBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Acme\\UserBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\Acme\\TagBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\Acme\\VoteBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Gedmo\\Translatable\\Entity');
        $c->addDriver($b, 'Gedmo\\Loggable\\Entity');
        $c->addDriver($b, 'Gedmo\\Tree\\Entity');
        $c->addDriver($b, 'Acme\\ProfileBundle\\Entity');
        $c->addDriver($b, 'Acme\\AlertBundle\\Entity');
        $c->addDriver($b, 'Acme\\UserBundle\\Entity');
        $c->addDriver($b, 'Acme\\TagBundle\\Entity');
        $c->addDriver($b, 'Acme\\VoteBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Tree\\Entity', 'AcmeProfileBundle' => 'Acme\\ProfileBundle\\Entity', 'AcmeAlertBundle' => 'Acme\\AlertBundle\\Entity', 'AcmeUserBundle' => 'Acme\\UserBundle\\Entity', 'AcmeTagBundle' => 'Acme\\TagBundle\\Entity', 'AcmeVoteBundle' => 'Acme\\VoteBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0b8d1ddfc5aedb95b8c1d2bb8c3f38108aee9f563a77e3323da052aec968fad6');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Acme\AlertBundle\Listener\DoctrineExtensionListener A Acme\AlertBundle\Listener\DoctrineExtensionListener instance.
     */
    protected function getExtension_ListenerService()
    {
        $this->services['extension.listener'] = $instance = new \Acme\AlertBundle\Listener\DoctrineExtensionListener();
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\ProfileBundle/Resources/views'), 'AcmeProfile');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\AlertBundle/Resources/views'), 'AcmeAlert');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\UserBundle/Resources/views'), 'AcmeUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\TagBundle/Resources/views'), 'AcmeTag');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\VoteBundle/Resources/views'), 'AcmeVote');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeProfileBundle' => 'Acme\\ProfileBundle\\AcmeProfileBundle',
                'AcmeAlertBundle' => 'Acme\\AlertBundle\\AcmeAlertBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'AcmeUserBundle' => 'Acme\\UserBundle\\AcmeUserBundle',
                'AcmeTagBundle' => 'Acme\\TagBundle\\AcmeTagBundle',
                'AcmeVoteBundle' => 'Acme\\VoteBundle\\AcmeVoteBundle',
